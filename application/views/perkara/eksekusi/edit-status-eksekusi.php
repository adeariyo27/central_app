    ...
    <section class="wrapper">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="background-color:#F1F2F7;">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Status Perkara Eksekusi Sukarela</li>
            </ol>
        </nav>
        <div class="col-lg-8">
            <section class="panel">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tanggal_surat" name="tanggal_surat" value="<?= $perkara_eks['tanggal_surat']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_eksekusi" id="status_eksekusi" class="form-control">
                            <?php foreach ($status_eks as $s) : ?>
                                <?php if ($s['status'] == $perkara_eks['status_eksekusi']) : ?>
                                    <option class="text-active font-weight-bolder" selected value="<?= $s['status'] ?>"><?= $s['status'] ?></option>
                                <?php else : ?>
