...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url('assets/img/gallery/icon_ca.ico'); ?>">

  <title>Central App - <?= $title; ?></title>
  ...
  <link href="<?= base_url('vendor/flatlab/'); ?>assets/morris.js-0.4.3/morris.css" rel="stylesheet" />
  <!-- datatables css -->
