                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($ikm as $i) : ?>
                                        <tr>
                                            ...
                                            <td><?= $i['fasilitas_informasi']; ?></td>
                                            <td><?= $i['fasilitas_toilet']; ?></td>
                                            <td>
                                                <a href="<?= base_url('survei/editprofilpengunjung/') . $i['id']; ?>" class="badge badge-primary"><i class="icon-pencil"></i></a>
                                                <a href="<?= base_url('survei/deleteprofilpengunjung/') . $i['id']; ?>" class="badge badge-danger tblHapusProfilpengunjung"><i class=" icon-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
